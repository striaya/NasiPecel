    ...
    <footer className="bg-espresso-900 text-cream-200 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-white/10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="font-display font-bold text-white text-base block leading-none">Nasi Pecel Mamah Satria</span>
            ...
            <p className="font-body text-xs text-cream-200/50 leading-relaxed max-w-56">
              UMKM kuliner yang menyajikan nasi pecel dengan cita rasa khas Indonesia, dibuat dari bahan-bahan segar pilihan dan diolah dengan penuh perhatian untuk menghadirkan rasa yang autentik dan nikmat.            </p>
          </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-body text-xs text-cream-200/40">
            © 2026 Nasi Pecel Mamah Satria. Semua hak dilindungi.
          </p>
