      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14 reveal">
          ...
          <p className="font-body text-sm text-cream-200/60 max-w-md mx-auto">
            Ribuan pelanggan puas telah menjadi bukti nyata cita rasa autentik Pecel Nusantara.
          </p>
        </div>
        ...
        <div className="mt-12 text-center reveal">
          <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-8 py-4">
            <div>
              ...
              <div className="font-body text-xs text-cream-300/70">dari 5.0</div>
            </div>
            ...
            <div>
              ...
              <div className="font-body text-xs text-cream-300/70">Berdasarkan 1.200+ ulasan</div>
            </div>
          </div>
        </div>
      </div>
