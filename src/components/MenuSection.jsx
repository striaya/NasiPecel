      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal">
          ...
          <p className="font-body text-base text-bark-600 dark:text-cream-200/60 max-w-lg mx-auto leading-relaxed">
            Setiap hidangan kami dibuat dari bahan-bahan segar pilihan, lalu dipadukan dengan bumbu kacang khas racikan sendiri yang sudah kami kembangkan dan sempurnakan selama lebih dari 12 tahun — memberikan rasa yang autentik dan selalu bikin rindu.          </p>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-300 ${added[item.id]
        ...
        <div className="text-center mt-12 reveal">
          <a
            href="https://wa.me/6285781573040?text=Halo%2C%20saya%20mau%20pesan%20Nasi%20Pecel!"
            target="_blank"
